...
@Plugin(id = "friends-api-mysql-proxy-bridge", name = "Friends-API-MySQL-Proxy-Bridge", version = "1.6.3-RELEASE",
...
public class FriendsAPIBridgeMainLoader {
	...
	public void onProxyInitialization(ProxyInitializeEvent event) {
		PAFPlugin.loadExtension(new VelocityExtensionLoadingInfo(new FriendsAPIBridgeMain(folder),
				"friends-api-mysql-proxy-bridge", "Loads Friends-API-MySQL-Proxy-Bridge", "1.6.3-RELEASE", "Simonsator"));
	}
}
